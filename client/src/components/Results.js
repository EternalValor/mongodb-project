                    ...
                    <div
                      ...
                      onClick={e => {
                        ...
                        !!this.props.query
                          ...
                          : this.props.advSearch({ type: index + 1 });
                        !!this.props.query
                          ? this.props.setQuery({
                              ...this.props.query,
                              type: index + 1
          ...
          <div className="publications">
            {this.props.publications.length ? (
              ...
              <div className="no-results">
                Oops we couldn't retrieve any results, please try again.
              </div>
            )}
            <div className="results-pager">
              <span className="left-arrow" onClick={this.props.pageLeft}>
                &nbsp;
              </span>
              {`${this.props.from} - ${this.props.to} of ${
                this.props.totalCount
              }`}
              <span className="right-arrow" onClick={this.props.pageRight}>
                &nbsp;
              </span>
            </div>
          </div>
