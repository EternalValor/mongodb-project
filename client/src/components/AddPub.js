  ...
  onSubmit = e => {
    if (this.state.pubToAdd.IF) {
      ...
      this.props.addPublication(
        e,
        { ...this.state.pubToAdd, type: this.state.selectedType },
        this.props.history.push
      );
    this.props.showPopup(
      `${this.state.pubToAdd.title.slice(0, 25)}... successfully added!!`,
      false
    );
        ...
        <div className="addpub">
          ...
          <form onSubmit={this.onSubmit} className="addpub-form">
            ...
            {this.state.selectedType > 0
                    ...
                    {field !== 'pages' ? (
                      ...
                      <span>
                        ...
                        <input
                          ...
                          value={
                            this.state.pubToAdd[field]
                              ? this.state.pubToAdd[field].begin
                              : 0
                          }
                          onChange={this.onChange}
              ...
              : null}
            {this.state.selectedType > 0 ? (
              <button className="addpub-btn">Done</button>
            ) : null}
          </form>
        </div>
      </div>
